...
if __name__ == "__main__":
    # Specify the parent folder path containing Camera1-Camera6 folders
    parent_folder_path = r"/home/haonan/proj/dannce-release_dev2/demo/hanshu_20260122_pre5/rat7--ACSF+0.1ugPTX"
